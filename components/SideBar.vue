...
<template>
      <div class="w-64 bg-white rounded-xl border">
        <div class="px-6 pt-8">
          <div class="flex items-center justify-between">
            ...
            ></a>
            <button
              class="flex items-center justify-center p-0.5 rounded bg-blue-600 focus:outline-none focus:ring-1 focus:ring-gray-500"
            >
              <svg
        ...
        <div class="px-6 pt-4">
          <div class="relative">
            ...
            <input
              type="text"
              class="w-full rounded pl-8 pr-4 py-2.5 text-sm font-medium bg-gray-1000 text-gray-700 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-white"
              placeholder="search"
            />
          </div>
        </div>
        ...
        <div class="px-6 pt-4">
          <ul class="flex flex-col space-y-2">
            <li class="relative text-gray-700 hover:text-white focus-within:text-white text-sm font-medium">
              <div
                class="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none"
              >
              ...
              <a
                href="#"
                class="inline-block w-full py-2 pl-8 pr-4 text-sm font-medium rounded hover:bg-blue-600 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800"
                >Dashboard</a
              >
            </li>
            <li class="text-sm font-medium">
              <div
                class="relative flex justify-between text-gray-700 hover:text-white focus-within:text-white"
              >
                <div class="flex items-center w-full">
                  ...
                  <a
                    href="#"
                    class="inline-block w-full py-2 pl-8 pr-4 rounded hover:bg-blue-600 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800"
                    >Content</a
                  >
                </div>
              ...
              <div class="pt-2 pl-4">
                <ul class="flex flex-col pl-2 text-sm font-medium text-gray-700 border-l border-gray-700">
                  <li>
                    <a
                      href="#"
                      class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-white"
                      >Courses</a
                    >
                  </li>
                  <li>
            ...
            <li class="relative text-gray-700 text-sm font-medium hover:text-white focus-within:text-white">
              <div
                class="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none"
              >
                <svg class="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
            ...
            <li class="relative text-gray-700 text-sm font-medium hover:text-white focus-within:text-white">
              ...
              <a
                href="#"
                class="inline-block w-full py-2 pl-8 pr-4 text-sm font-medium rounded hover:bg-blue-600 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-blue-600"
                >Market & sell</a
              >
            </li>
            <li class="relative text-gray-700 text-sm font-medium hover:text-white focus-within:text-white">
        ...
        <div class="px-6 pt-4 pb-8">
          <ul>
            ...
            <li class="relative text-gray-700 hover:text-white focus-within:text-white">
              <div
                class="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none"
              >
                <svg class="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
            ...
            <li class="relative text-gray-700 text-sm font-medium hover:text-white focus-within:text-white">
              ...
              <a
                href="#"
                class="inline-block w-full py-2 pl-8 pr-4 text-sm rounded hover:bg-blue-600 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-blue-600"
                >Apps</a
              >
            </li>
          </ul>
        </div>
        <div class="pl-6 pr-4 py-4 bg-gray-50 flex items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="flex flex-col pl-3">
              <div class="text-sm text-slate-900">Admin</div>
              <span class="text-xs text-slate-900 font-light tracking-tight">
                admin@demo.com
              </span>
            </div>
          </div>
          <button
            class="text-gray-400 bg-blue-600 rounded focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-white"
          >
